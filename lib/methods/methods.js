      ...
      addComments: function(commentInput, postId){
       ...
       joinRequest: function(thisModuleId, Name){
            if(!Meteor.userId()){
               ...
               Modules.update(thisModuleId,{$addToSet: {requested: {name: Name}}});
       ...
       deleteRequest:function(adminId, thisModule, Name){
            if(!Meteor.userId()){
               ...
               Modules.update({admin_id:adminId, moduleName: thisModule},{ $pull: { requested: { name : Name} } })
           }
       },
       ...
       approveRequest: function(adminId, thisModule, Name){
            if(!Meteor.userId()){
               ...
               Modules.update({admin_id:adminId, moduleName: thisModule},{$addToSet: {approved: {name:  Name}}});
       ...
       rejectRequest: function(adminId, thisModule, Name){
            if(!Meteor.userId()){
               ...
               Modules.update(thisModule,{$addToSet: {rejected: Name}});
